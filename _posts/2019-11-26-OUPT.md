...
Read more about the tools, including links to the code, [here](https://web.archive.org/web/20260118085458/https://blogs.iadb.org/conocimiento-abierto/en/open-urban-planning-toolbox/).

<!-- (https://blogs.iadb.org/conocimiento-abierto/en/open-urban-planning-toolbox/).  -->
