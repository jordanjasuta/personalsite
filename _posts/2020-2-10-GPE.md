...
Project led by urbanist data scientist [Antonio Vasquez Brust](https://bitsandbricks.github.io/), and described in detail in the IDB's blog [Behind the scenes: Big Data analysis for public policy](https://www.iadb.org/en/blog/urban-development-and-housing/behind-scenes-big-data-analysis-public-policy) 
